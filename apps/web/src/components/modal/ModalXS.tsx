...
export function ModalXs(props: {showBox: boolean, closed: () => void, isLoading: boolean, children: React.ReactNode}) {
    return (
            ...
            <div className="fixed inset-0 overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-2 text-center">
                    ...
                    >
                        ...
                        <div className="justify-center items-center p-4 overflow-auto">
